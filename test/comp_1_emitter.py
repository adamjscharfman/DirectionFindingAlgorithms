...
steering_vectors,antenna_pattern = array_manifold.antenna_pattern_estimate_loop(f_range,az_range,el_range,rx_coords)
...
signal = 10**(snr_dB/20) * np.exp(1j*2*np.pi * tone_offset * time_vec)
